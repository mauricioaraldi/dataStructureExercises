/**
 * From CodeWars -- https://www.codewars.com/kata/5526fc09a1bbd946250002dc
 *
...
function findOutlier(integers) {
  const isEven = integers.slice(0, 3).filter(i => i%2 === 0).length >= 2;
  return integers.find(i => (isEven && Math.abs(i)%2 === 1) || (!isEven && Math.abs(i)%2 === 0));
}
