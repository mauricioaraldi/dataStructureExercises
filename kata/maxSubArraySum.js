/**
 * From CodeWars -- https://www.codewars.com/kata/550498447451fbbd7600041c
 *
 ...
 * (the multiplicity of a member is the number of times it appears). "Same"
...
function comp(array1, array2) {
  ...
  let squares = array2.slice(0);

  for (let i = array1.length - 1; i >= 0; i--) {
    let number = array1[i],
      index = squares.indexOf(number * number);
