/**
 * From CodeWars -- https://www.codewars.com/kata/563b662a59afc2b5120000c6
 *
 ...
 * 1070 + 1070 * 0.02 + 50 => 1141 inhabitants (number of inhabitants is integer)
 *
 ...
 * - aug is an integer, percent a positive or null floating number, p0 and
 ...
 */
function nbYear(curPopulation, percentIntGrow, intGrow, goal) {
  let percentGrow = percentIntGrow / 100,
    yearsNeeded = 0;

  while (curPopulation < goal) {
    let newPopulation = curPopulation + curPopulation * percentGrow + intGrow;

    if (newPopulation < curPopulation && goal > curPopulation) {
      throw new error('Population is not growing');
    }
