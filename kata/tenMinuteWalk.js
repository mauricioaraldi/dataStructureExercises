/**
 * From CodeWars -- https://www.codewars.com/kata/54da539698b8a2ad76000228
 *
...
function isValidWalk(walk) {
  ...
  while (directions.length) {
    let nextDirection = directions[0],
      nextOppositeIndex = directions.indexOf(opposites[nextDirection]);

    if (nextOppositeIndex == -1) {
      return false;
    }

    directions.splice(nextOppositeIndex, 1);
    directions.shift();
  }
